...
SUDO = SUDO
sudo_users = {SUDO,895757550,895757550}   
print([[
> CH › @DV4VD
> CH › @DVL_DEV
~> DEVELOPER › @X_1_1
...
io.popen("cd library && wget https://raw.githubusercontent.com/DVL_DEV/MAYA/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DVL_DEV/Files_MAYA/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMAYAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1910746321) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(895757550) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
local UserName = (data.username_ or "DV4VD")
...
MAYA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MAYA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MAYA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MAYA_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@X_1_1")  
...
--------------------------------------------------------------------------------------------------------------
function SourceMAYA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."MAYA1:List:Filter"..sl)
...
if not DevMAYAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMAYAW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,MAYA_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ☆' and DevMAYAW(msg) then  
...
if text == 'تعطيل التواصل ☆' and DevMAYAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ☆' and DevMAYAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ☆' and DevMAYAW(msg) then  
...
if text == 'ضع كليشه ستارت ☆' and DevMAYAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *☆︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ☆' and DevMAYAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *☆︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ☆' and DevMAYAW(msg) then 
...
if text == 'تحديث السورس ☆' and DevMAYAW(msg) then 
os.execute('rm -rf MAYA.lua')
os.execute('wget https://raw.githubusercontent.com/DVL_DEV/MAYA/main/MAYA.lua')
send(msg.chat_id_, msg.id_,' *☆︙تم تحديث السورس* \n*☆︙لديك اخر اصدار لسورس تيلاند*\n*☆︙الاصدار » { 2.8v}*')
dofile('MAYA.lua')  
end
if text == 'الاصدار ☆' and DevMAYAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *☆︙اصدار سورس تيلاند* \n*☆︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ☆' and DevMAYAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ☆︙[تحديثات البوت](t.me/DVL_DEV) \n☆︙[قناه السورس](t.me/DV4VD)')
end
if text == "ضع اسم للبوت ☆" and DevMAYAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *☆︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ☆' and DevMAYAW(msg) then 
...
if text == 'المشتركين ☆' and DevMAYAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *☆︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ☆' and DevMAYAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *☆︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ☆") and DevMAYAW(msg) then
...
if text == ("قائمه العام ☆") and DevMAYAW(msg) then
...
if text == ("قائمه الكتم العام ☆") and DevMAYAW(msg) then
...
if text=="اذاعه خاص ☆" and msg.reply_to_message_id_ == 0 and DevMAYAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☆︙ارسل الان اذاعتك؟* \n*☆︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ☆" and msg.reply_to_message_id_ == 0 and DevMAYAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☆︙ارسل الان اذاعتك؟* \n*☆︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ☆" and msg.reply_to_message_id_ == 0 and DevMAYAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☆︙ارسل الان اذاعتك؟* \n*☆︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ☆" and msg.reply_to_message_id_ == 0  and DevMAYAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *☆︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ☆" and msg.reply_to_message_id_ == 0  and DevMAYAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ☆︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ☆' and DevMAYAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ☆" and DevMAYAW(msg) then
...
if text == "تنظيف الكروبات ☆" and DevMAYAW(msg) then 
...
send(msg.chat_id_, msg.id_,'*☆︙عدد الكروبات الان » { '..#group..' }'..MAYAk..''..MAYA..'*\n*☆︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMAYAW(msg) then
...
usertext = '*\n ☆︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'DV4VD')..')'
status  = '\n *☆︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevMAYAW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *☆︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DV4VD')..')'
status  = '\n*☆︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMAYAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMAYAW(msg) then
...
local MAYA1_Msg = database:get(bot_id.."MAYA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MAYA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *☆︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DV4VD')..') \n ☆︙'..MAYA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MAYA_Msg and not Special(msg) then  
local MAYA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MAYA_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *☆︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n☆︙["..MAYA_Msg.."] \n")
else
send(msg.chat_id_,0," *☆︙العضو :* {["..data.first_name_.."](T.ME/DV4VD)}\n☆︙["..MAYA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *☆︙عذرا ↫* {["..data.first_name_.."](T.ME/DV4VD)}\n*☆︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMAYAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMAYAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMAYAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *☆︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMAYAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *☆︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ☆" and DevMAYAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *☆︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☆$") and DevMAYAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *☆︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ☆" and DevMAYAW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ☆" and DevMAYAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *☆︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ☆" and DevMAYAW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."MAYA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MAYA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_MAYA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MAYA then 
names_MAYA = database:smembers(bot_id.."MAYA:blocname"..msg.chat_id_) or ""
if names_MAYA and names_MAYA[1] then 
for i=1,#names_MAYA do 
if name_MAYA:match("(.*)("..names_MAYA[i]..")(.*)") then 
...
database:set(bot_id.."MAYA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MAYA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MAYA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MAYA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MAYA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_MAYAa_new(MAYA1,MAYA2)
if MAYA2 and MAYA2.first_name_ then 
if MAYA2.first_name_:match("(.*)"..database:get(bot_id.."MAYA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MAYA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local MAYA_nnn = database:get(bot_id.."MAYA:nump"..msg.chat_id_) or 5
local MAYA_nnn2 = database:get(bot_id.."MAYA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(MAYA_nnn2) == tonumber(MAYA_nnn) or tonumber(MAYA_nnn2) > tonumber(MAYA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MAYA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☆︙عزيزي >>["..MAYA2.username_.."](https://t.me/"..(MAYA2.username_ or "DV4VD")..")\n☆︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MAYA:teh"..msg.chat_id_).."} بجانب اسمك\n☆︙عدد المحاولات المتبقيه {"..(tonumber(MAYA_nnn) - tonumber(MAYA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_MAYAa_new)
end
end
...
local MAYAChengName = database:get(bot_id.."MAYA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MAYAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MAYAChengName..']')
database:del(bot_id.."MAYA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MAYAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MAYA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MAYAChengUserName = database:get(bot_id.."MAYA:Cheng:UserName"..data.id_)
if not data.username_ then 
if MAYAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MAYAChengUserName..']')
database:del(bot_id.."MAYA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MAYAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MAYA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MAYAChengPhoto = database:get(bot_id.."MAYA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MAYAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MAYA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MAYAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MAYA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://vvvzvv.ml/apiMAYA/MAYA.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'☆︙شترك في قناة السورس اولآ @DVL_DEV .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ\n\n[☆  ᴛᴇʟᴀɴᴅ ᴄʜᴀɴɴᴇʟ](http://t.me/DVL_DEV)\n\n[☆  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/DV4VD)\n\n[☆  ᴛᴇʟᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/X_1_1)\n\n[☆  ʙᴏᴛ ᴛᴇʟᴀɴᴅ](http://t.me/Tilllandbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☆ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url="t.me/DVL_DEV/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DVL_DEV&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevMAYAW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*☆︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'DV4VD')..') \n*☆︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *☆︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DV4VD')..') \n*☆︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevMAYAW(msg) then
dofile('MAYA.lua')  
send(msg.chat_id_, msg.id_, ' *☆︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevMAYAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMAYAW(msg) then  
function start_function(extra, result, success)
if MAYASudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMAYAW(msg) then  
...
if MAYASudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*☆︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevMAYAW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if MAYASudoBot(userid) then
send(msg.chat_id_, msg.id_,"*☆︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMAYAW(msg) then  
function start_function(extra, result, success)
if MAYASudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*☆︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevMAYAW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevMAYAW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if MAYASudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*☆︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMAYAW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevMAYAW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevMAYAW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevMAYAW(msg) then
...
if text == 'الملفات' and DevMAYAW(msg) then
...
if DevMAYAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MARIOTEAM/Files_MARIO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *☆︙اهلا بك في متجر ملفات تيلاند*\n*☆︙ملفات السورس ↓*\n*༺┉𖦹┉┉ꕥ┉┉𖦹┉༻*\n\n"
local TextE = "\n*༺┉𖦹┉┉ꕥ┉┉𖦹┉༻*\n *☆︙علامة تعني { ✓ } ملف مفعل*\n *☆︙علامة تعني { ✘ } ملف معطل*\n *☆︙قناة سورس تيلاند ↓*\n".." *☆︙*[اضغط هنا لدخول](t.me/DV4VD) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMAYAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MARIOTEAM/Files_MARIO/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMAYAW(msg) then
...
if text == "مسح الملفات" and DevMAYAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *☆︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMAYAW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMAYAW(msg) then  
function start_function(extra, result, success)
...
function Function_MAYA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MAYA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MAYA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *☆︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'DV4VD')..')'
status  = '\n*☆︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *☆︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DV4VD')..')'
status  = '\n*☆︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *☆︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *☆︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DV4VD')..')'
...
local TexMAY = {string.match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexMAY[3] == 'يوم' then
Time_Restrict = TexMAY[2]:match('(%d+)')
Time = Time_Restrict * 86400
end
if TexMAY[3] == 'ساعه' then
Time_Restrict = TexMAY[2]:match('(%d+)')
Time = Time_Restrict * 3600
end
if TexMAY[3] == 'دقيقه' then
Time_Restrict = TexMAY[2]:match('(%d+)')
Time = Time_Restrict * 60
end
TexMAY[3] = TexMAY[3]:gsub('دقيقه',"دقايق") 
TexMAY[3] = TexMAY[3]:gsub('ساعه',"ساعات") 
TexMAY[3] = TexMAY[3]:gsub("يوم","ايام") 
if MAYASudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*☆︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = TexMAY[4]}, start_function, nil)
return false
end
...
local TexMAY = {string.match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexMAY[3] == 'يوم' then
Time_Restrict = TexMAY[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *☆︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DV4VD')..')'
status  = '\n*☆︙تم تقيده لمدة ~* { '..TexMAY[2]..' '..TexMAY[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
local TEXT_SUD = database:get(bot_id..'MAYA:TEXT_SUDO')
if TEXT_SUDO then 
...
database:set(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *☆︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MAYA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MAYA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *☆︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MAYA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MAYA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MAYA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *☆︙ارسل الكلمه الان*")  
database:set(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MAYA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MAYA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MAYA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MAYA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MAYA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MAYA1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevMAYAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *☆︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMAYAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *☆︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'DV4VD')..')'..'\n*☆︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMAYAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMAYAW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..MAYA_Msg[math.random(#MAYA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMAYAW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,MAYA)
local t = "\n*ツ قائمة الاعضاء* \n*༺┉𖦹┉┉ꕥ┉┉𖦹┉༻*\n"
x = 0
local list = MAYA.members_
for k, v in pairs(list) do
x = x + 1
...
if MAYASudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMAYAW(msg) then 
...
if text == ("ردود المطور") and DevMAYAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ☆︙قائمة ردود المطور \n*༺┉𖦹┉┉ꕥ┉┉𖦹┉༻*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMAYAW(msg) then    
send(msg.chat_id_, msg.id_,' *☆︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevMAYAW(msg) then    
...
if text == 'تفعيل المغادره' and DevMAYAW(msg) then   
...
if text == 'تعطيل المغادره' and DevMAYAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*☆︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'DVL_DEV')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DV4VD')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MAYAdx(msg.chat_id_, msg.id_, ' *☆︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*☆︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*☆︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*☆︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMAYAW(msg) then
...
{{text = '𝙼𝙰𝚁𝙸𝙾 𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/DVL_DEV"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/MAYA.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*☆︙قائمه الزخرفه* \nٴ☆∫ٴ*༺┉𖦹┉┉ꕥ┉┉𖦹┉༻*ٴ☆∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ☆∫ٴ*༺┉𖦹┉┉ꕥ┉┉𖦹┉༻*ٴ☆∫○ٴ\n☆︙[𝙼𝙰𝚁𝙸𝙾 𝚂𝙾𝚄𝚁𝙲𝙴](t.me/DV4VD) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/MAYA.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/MAYA.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/MAYA.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/DVL_DEV'}},
}
...
MAYA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MAYA)
...
------------------------------------------------------------------------
local MAYAAbot = database:get(bot_id.."MAYA1:Add:Filter:Rp2"..text..result.chat_id_)   
if MAYAAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *☆︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n☆︙["..MAYAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MAYA1_Msg = database:get(bot_id.."MAYA1:Add:Filter:Rp2"..text..result.chat_id_)   
if MAYA1_Msg then
send(msg.chat_id_, msg.id_," ☆︙"..MAYA1_Msg)

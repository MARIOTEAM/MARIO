...
SUDO = SUDO
sudo_users = {SUDO,1910746321,895757550}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/MARIOTEAM/MARIO/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MARIOTEAM/Files_MARIO/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMARIOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local MARIO_Msg = ''  
if msgs < 100 then 
MARIO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MARIO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MARIO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MARIO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
MARIO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MARIO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MARIO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MARIO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MARIO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MARIO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MARIO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MARIO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MARIO_Msg = 'رب التفاعل'  
end 
return MARIO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMARIO(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."MARIO1:List:Filter"..sl)
...
if not DevMARIOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMARIOW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,MARIO_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ❈' and DevMARIOW(msg) then  
...
if text == 'تعطيل التواصل ❈' and DevMARIOW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❈' and DevMARIOW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❈' and DevMARIOW(msg) then  
...
if text == 'ضع كليشه ستارت ❈' and DevMARIOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *❈︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ❈' and DevMARIOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *❈︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ❈' and DevMARIOW(msg) then 
...
if text == 'تحديث السورس ❈' and DevMARIOW(msg) then 
os.execute('rm -rf MARIO.lua')
os.execute('wget https://raw.githubusercontent.com/MARIOTEAM/MARIO/main/MARIO.lua')
send(msg.chat_id_, msg.id_,' *❈︙تم تحديث السورس* \n*❈︙لديك اخر اصدار لسورس تيلاند*\n*❈︙الاصدار » { 2.8v}*')
dofile('MARIO.lua')  
end
if text == 'الاصدار ❈' and DevMARIOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *❈︙اصدار سورس تيلاند* \n*❈︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ❈' and DevMARIOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❈︙[تحديثات البوت](t.me/DVL_DEV) \n❈︙[قناه السورس](t.me/vvvmh)')
end
if text == "ضع اسم للبوت ❈" and DevMARIOW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ❈' and DevMARIOW(msg) then 
...
if text == 'المشتركين ❈' and DevMARIOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❈︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❈' and DevMARIOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❈︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❈") and DevMARIOW(msg) then
...
if text == ("قائمه العام ❈") and DevMARIOW(msg) then
...
if text == ("قائمه الكتم العام ❈") and DevMARIOW(msg) then
...
if text=="اذاعه خاص ❈" and msg.reply_to_message_id_ == 0 and DevMARIOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل الان اذاعتك؟* \n*❈︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ❈" and msg.reply_to_message_id_ == 0 and DevMARIOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل الان اذاعتك؟* \n*❈︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ❈" and msg.reply_to_message_id_ == 0 and DevMARIOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل الان اذاعتك؟* \n*❈︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ❈" and msg.reply_to_message_id_ == 0  and DevMARIOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❈︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ❈" and msg.reply_to_message_id_ == 0  and DevMARIOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❈︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❈' and DevMARIOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❈" and DevMARIOW(msg) then
...
if text == "تنظيف الكروبات ❈" and DevMARIOW(msg) then 
...
send(msg.chat_id_, msg.id_,'*❈︙عدد الكروبات الان » { '..#group..' }'..MARIOk..''..MARIO..'*\n*❈︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMARIOW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevMARIOW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMARIOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMARIOW(msg) then
...
local MARIO1_Msg = database:get(bot_id.."MARIO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MARIO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if MARIO_Msg and not Special(msg) then  
local MARIO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MARIO_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMARIOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMARIOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMARIOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMARIOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ❈" and DevMARIOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *❈︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❈$") and DevMARIOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❈︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❈" and DevMARIOW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ❈" and DevMARIOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *❈︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ❈" and DevMARIOW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."MARIO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MARIO:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_MARIO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MARIO then 
names_MARIO = database:smembers(bot_id.."MARIO:blocname"..msg.chat_id_) or ""
if names_MARIO and names_MARIO[1] then 
for i=1,#names_MARIO do 
if name_MARIO:match("(.*)("..names_MARIO[i]..")(.*)") then 
...
database:set(bot_id.."MARIO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MARIO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MARIO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MARIO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MARIO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_MARIOa_new(MARIO1,MARIO2)
if MARIO2 and MARIO2.first_name_ then 
if MARIO2.first_name_:match("(.*)"..database:get(bot_id.."MARIO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MARIO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local MARIO_nnn = database:get(bot_id.."MARIO:nump"..msg.chat_id_) or 5
local MARIO_nnn2 = database:get(bot_id.."MARIO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(MARIO_nnn2) == tonumber(MARIO_nnn) or tonumber(MARIO_nnn2) > tonumber(MARIO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MARIO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❈︙عزيزي >>["..MARIO2.username_.."](https://t.me/"..(MARIO2.username_ or "vvvmh")..")\n❈︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MARIO:teh"..msg.chat_id_).."} بجانب اسمك\n❈︙عدد المحاولات المتبقيه {"..(tonumber(MARIO_nnn) - tonumber(MARIO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_MARIOa_new)
end
end
...
local MARIOChengName = database:get(bot_id.."MARIO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MARIOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MARIOChengName..']')
database:del(bot_id.."MARIO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MARIOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MARIO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MARIOChengUserName = database:get(bot_id.."MARIO:Cheng:UserName"..data.id_)
if not data.username_ then 
if MARIOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MARIOChengUserName..']')
database:del(bot_id.."MARIO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MARIOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MARIO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MARIOChengPhoto = database:get(bot_id.."MARIO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MARIOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MARIO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MARIOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MARIO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevMARIOW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevMARIOW(msg) then
dofile('MARIO.lua')  
send(msg.chat_id_, msg.id_, ' *❈︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevMARIOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMARIOW(msg) then  
function start_function(extra, result, success)
if MARIOSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMARIOW(msg) then  
...
if MARIOSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevMARIOW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if MARIOSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMARIOW(msg) then  
function start_function(extra, result, success)
if MARIOSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevMARIOW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevMARIOW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if MARIOSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*❈︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMARIOW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevMARIOW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevMARIOW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevMARIOW(msg) then
...
if text == 'الملفات' and DevMARIOW(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMARIOW(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMARIOW(msg) then
...
if text == "مسح الملفات" and DevMARIOW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *❈︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMARIOW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMARIOW(msg) then  
function start_function(extra, result, success)
...
function Function_MARIO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MARIO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MARIO, nil)
return false 
end
...
local TEXT_SUD = database:get(bot_id..'MARIO:TEXT_SUDO')
if TEXT_SUDO then 
...
database:set(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *❈︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MARIO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MARIO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *❈︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MARIO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MARIO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MARIO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *❈︙ارسل الكلمه الان*")  
database:set(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MARIO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MARIO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MARIO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MARIO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MARIO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MARIO1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevMARIOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *❈︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMARIOW(msg) then
...
if text == 'تفعيل الاذاعه' and DevMARIOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMARIOW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..MARIO_Msg[math.random(#MARIO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMARIOW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,MARIO)
local t = "\n*ツ قائمة الاعضاء* \n*༺┉┉𖦹┉┉ꕥ┉┉𖦹┉┉༻*\n"
x = 0
local list = MARIO.members_
for k, v in pairs(list) do
x = x + 1
...
if MARIOSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMARIOW(msg) then 
...
if text == ("ردود المطور") and DevMARIOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❈︙قائمة ردود المطور \n*༺┉┉𖦹┉┉ꕥ┉┉𖦹┉┉༻*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMARIOW(msg) then    
send(msg.chat_id_, msg.id_,' *❈︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevMARIOW(msg) then    
...
if text == 'تفعيل المغادره' and DevMARIOW(msg) then   
...
if text == 'تعطيل المغادره' and DevMARIOW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*❈︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MARIOTEAM')..') '
...
-- vardump(data) 
MARIOdx(msg.chat_id_, msg.id_, ' *❈︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*❈︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*❈︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*❈︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMARIOW(msg) then
...
{{text = '𝑀𝐴𝑅𝐼𝑂 𝑇𝐸𝐴𝑀', url="t.me/DVL_DEV"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/MARIO.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*❈︙قائمه الزخرفه* \nٴ❈∫ٴ*༺┉┉𖦹┉┉ꕥ┉┉𖦹┉┉༻*ٴ❈∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/MARIO.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/MARIO.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/MARIO.php')
if res == 200 then
...
{{text = '𝚂𝙾𝚄𝚁𝙲𝚁 𝙼𝙰𝚁𝙸𝙾',url='http://t.me/DVL_DEV'}},
}
...
MARIO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MARIO)
...
--------------------------------------------------------------------------------------------------------------
SourceMARIO(data.message_,data)
...
------------------------------------------------------------------------
local MARIOAbot = database:get(bot_id.."MARIO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MARIOAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❈︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❈︙["..MARIOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MARIO1_Msg = database:get(bot_id.."MARIO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MARIO1_Msg then
send(msg.chat_id_, msg.id_," ❈︙"..MARIO1_Msg)

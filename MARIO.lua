...
if DevMAYAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DVL_DEV/Files_MAYA/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DVL_DEV/Files_MAYA/main/File_Bot/"..file)
if res == 200 then

...
local RunBot = io.open("MARIO", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/MARIO
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr MARIO.lua
wget "https://raw.githubusercontent.com/MARIOTEAM/MARIO/main/MARIO.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./MARIO.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S MARIO -X kill
screen -S MARIO ./MARIO
done
]])
RunTs:close()
end

...
io.popen("cd library && wget https://raw.githubusercontent.com/MAYATEAM/MAYA/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MAYATEAM/Files_MAYA/main/File_Bot/commands.lua") 
...
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(2063143862) then
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
...
os.execute('wget https://raw.githubusercontent.com/MAYATEAM/MAYA/main/MAYA.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/MAYATEAM) \n⌯︙[قناه السورس](t.me/vvvmh)')
end
...
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @MAYATEAM .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ\n\n[⌯  ᴛᴇʟᴀɴᴅ ᴄʜᴀɴɴᴇʟ](http://t.me/MAYATEAM)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/vvvmh)\n\n[⌯  ᴛᴇʟᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/IMMHH)\n\n[⌯  ʙᴏᴛ ᴛᴇʟᴀɴᴅ](http://t.me/Tilllandbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url="t.me/MAYATEAM/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MAYATEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
if DevMAYAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MAYATEAM/Files_MAYA/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MAYATEAM/Files_MAYA/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MAYATEAM')..') '
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/MAYATEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/MAYATEAM'}},
}
